...
LIMIT 50 OFFSET 50
 ...
 --Як нам дізнатися скілька потрібно відступати
    ...
    // == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == == --створити запит з об'єднаними стовпцями
SELECT id,
...
FROM users
 ...
 --знайти користувачів, де Full name менше 10 символів
SELECT id,
    concat(first_name, ' ', last_name) AS "Full name",
    gender,
    email
...
FROM 
(
        SELECT  id, concat(first_name, ' ', last_name) AS "Full name",  gender, email
        FROM users
    )  AS "FN"
